  ...
  methods: {
    ...
    findFilteredNodes: function findFilteredNodes(node2, paramsWithoutNode) {
      if (node2) {
        var matched = false;
        if (node2.children) {
          var childNodes = _toConsumableArray2(node2.children);
          node2.children = [];
...
var _hoisted_28 = ["aria-labelledby", "aria-label"];
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("input")), null, 16, _hoisted_18), [[vModelText, $data.filterValue]]), renderSlot(_ctx.$slots, "searchicon", {
